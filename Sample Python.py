...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to MoneyTalks. " \
...
def get_netWorth(intent, session):
    ...
    speech_output = "Your net worth is " + str(net_Worth) + " Dollars . Have a great one big boi."
...
def on_intent(intent_request, session):
    ...
    elif intent_name == "NetWorthIntent":
        return get_netWorth(intent, session)
    else:
